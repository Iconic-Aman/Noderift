...
export const actionTemplates: NodeTemplate[] = [
  ...
  },
  {
    ...
    category: "actions",
    color: "#ea4335",
    description: "Send email via Gmail with attachments",
    configFields: [
      ...
      { name: "body", label: "Body", type: "textarea", placeholder: "Email body or HTML..." },
      { name: "attachment", label: "Attachment / File", type: "text", placeholder: "{code-1.excel_file} or filename.xlsx" },
    ],
  },
  {
    id: "whatsapp",
